      ...
      <section className="py-16 sm:py-20 bg-[#f8f9fa]">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div {...fadeUp} transition={{ duration: 0.55 }} className="mb-10 sm:mb-12">
            ...
            <h2 className="heading-md text-gray-900 mb-2">개발 프로세스</h2>
            <p className="text-gray-500 text-sm max-w-md">체계적인 프로세스로 고품질의 결과물을 만들어갑니다.</p>
          </motion.div>
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="space-y-0">
              {sortedSteps.map((step, index) => (
                ...
                >
                  {/* 번호 원 */}
                  <div className="relative z-10 flex-shrink-0 w-10 h-10 rounded-full border-2 border-[#3b82f6] bg-[#f8f9fa] flex items-center justify-center">
                    <span className="text-xs font-bold text-[#3b82f6] font-mono-stat">
