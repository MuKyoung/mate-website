          ...
          <div className="grid lg:grid-cols-12 gap-y-12 gap-x-8">
            <div className="lg:col-span-4">
              <motion.div {...inView} variants={fadeUp} className="lg:sticky lg:top-28">
                <p className="text-[13px] text-[#a1a1aa] mb-4">01 — Services</p>
                <h2 className="text-[#0a0a0a] font-semibold tracking-[-0.025em] leading-[1.1] mb-6"
                  style={{ fontSize: 'clamp(1.875rem, 3.5vw, 2.75rem)' }}>
                  게임 · 웹 · 앱 개발
                </h2>
                <Link href="/services"
                  className="group inline-flex items-center gap-1.5 text-[14px] text-[#52525b] hover:text-[#0a0a0a] transition-colors">
                  모든 서비스 보기
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-14 gap-x-8">
            <div className="lg:col-span-5">
              <p className="text-[13px] text-white/35 mb-4">03 — Why MATE</p>
              <motion.h2 {...inView} variants={stagger}
                className="text-white font-semibold tracking-[-0.03em] leading-[1.1] mb-7"
                ...
                <span className="block overflow-hidden"><motion.span variants={clipUp} className="block text-white/35">끝까지 함께합니다</motion.span></span>
              </motion.h2>
              <motion.p {...inView} variants={fadeUp} className="text-[15px] text-white/55 leading-[1.75] max-w-md mb-9">
            ...
            <motion.div {...inView} variants={stagger} className="lg:col-span-6 lg:col-start-7">
              {metrics.map((item) => (
                <motion.div key={item.label} variants={fadeUp}
                  ...
                  <span className="text-xl sm:text-2xl font-semibold text-white font-mono-stat tracking-tight">{item.metric}</span>
                  <div>
                    <p className="text-[15px] font-medium text-white mb-1">{item.label}</p>
      ...
      <section className="py-24 sm:py-32 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div {...inView} variants={fadeUp}
            ...
            <span className="text-[13px] text-[#a1a1aa]">04</span>
            <h2 className="text-[#0a0a0a] font-semibold tracking-[-0.025em]"
              style={{ fontSize: 'clamp(1.875rem, 3.5vw, 2.75rem)' }}>
              고객 후기
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10">
            <motion.div {...inView} variants={stagger}>
              ...
              <h2 className="text-white font-semibold tracking-[-0.03em] leading-[1.05] mb-5"
