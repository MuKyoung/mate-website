...
import {
  fadeUp, fadeLeft, fadeRight, riseTilt, clipUp, clipLeft, stagger, inView,
} from '@/lib/motion';
import { container, hairlineCell, sectionPad } from '@/lib/styles';
...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className={sectionPad}>
        <div className={container}>
          ...
          <motion.div {...inView} variants={stagger}
            ...
            {metrics.map((m, i) => (
              <motion.div key={m.label} variants={i % 2 === 0 ? fadeUp : riseTilt}
                className={`py-9 sm:py-12 ${hairlineCell(i)}`}>
      ...
      {/* ━━ (06) CTA ━━ */}
      <CtaSection num="06" kr="당신의 멋진 상상을 현실로 만들어보세요" />
    </>
  );
}
