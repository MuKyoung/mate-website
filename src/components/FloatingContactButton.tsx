    ...
    <AnimatePresence>
      ...
      >
        <motion.div whileTap={{ scale: 0.97 }}>
          <Link
            href="/contact"
            className="flex items-center gap-2 px-5 py-3 sm:px-6 sm:py-3.5 rounded-sm font-medium text-white bg-[#0a0a0a] hover:bg-[#333] shadow-lg transition-colors duration-150"
          >
